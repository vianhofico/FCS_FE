...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-[85vh] items-center justify-center overflow-hidden px-4 py-10">
      <div className="pointer-events-none absolute right-0 top-20 h-72 w-72 translate-x-1/2 rounded-full bg-primary/5 blur-3xl" />
      <div className="pointer-events-none absolute bottom-10 left-0 h-80 w-80 -translate-x-1/2 rounded-full bg-accent/10 blur-3xl" />
